...
func main() {
	...
	http.Handle("/", handlers.CORS(allowedOrigins, allowedMethods, allowedHeaders, allowCredentials)(playground.Handler("GraphQL playground", "/query")))
	http.Handle("/query", handlers.CORS(allowedOrigins, allowedMethods, allowedHeaders, allowCredentials)(srv))
